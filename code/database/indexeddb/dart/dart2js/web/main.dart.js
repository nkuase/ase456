...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1, t2, body, _this;
      A.print("\ud83d\ude80 Main function is executing!");
      t1 = init.G;
      t2 = type$.JSObject;
      body = type$.nullable_JSObject._as(t2._as(t1.document).body);
      if (body != null) {
        _this = t2._as(t2._as(t1.document).createElement("div"));
        _this.textContent = "\u2705 This was added by main() function!";
        t2._as(_this.style).fontSize = "14px";
        t2._as(_this.style).color = "green";
        t2._as(_this.style).padding = "20px";
        t2._as(_this.style).border = "2px solid green";
        t2._as(_this.style).margin = "20px";
        t2._as(_this.style).backgroundColor = "#e8f5e8";
        t2._as(body.appendChild(_this));
      }
      A.print("\ud83c\udf89 main() executed successfully");
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.ListIterator.prototype = {
    ...
    moveNext$0() {
      ...
      _this.__internal$_current = t2.$index(t1, t3);
