...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    openDb() {
      ...
      var $async$openDb = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1.toString;
              $async$goto = 3;
              return A._asyncAwait(B.IdbFactory_methods.open$3$onUpgradeNeeded$version(t1, "myDB", new A.openDb_closure(), 1), $async$openDb);
            case 3:
      ...
      return A._asyncStartSync($async$openDb, $async$completer);
    },
    create(data) {
      return A.create$body(data);
    },
    create$body(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, key, tx, t1, $async$temp1;
      var $async$create = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$temp1 = B.Database_methods;
              $async$goto = 3;
              return A._asyncAwait(A.openDb(), $async$create);
            case 3:
              // returning from await.
              tx = $async$temp1.transaction$2($async$result, "myStore", "readwrite");
              t1 = tx.objectStore("myStore");
              t1.toString;
              $async$goto = 4;
              return A._asyncAwait(B.ObjectStore_methods.add$1(t1, data), $async$create);
            case 4:
              // returning from await.
              key = $async$result;
              $async$goto = 5;
              return A._asyncAwait(B.Transaction_methods.get$completed(tx), $async$create);
            case 5:
              // returning from await.
              $async$returnValue = A._asInt(key);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$create, $async$completer);
    },
    read(key) {
      return A.read$body(key);
    },
    read$body(key) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_Map_String_dynamic),
        $async$returnValue, result, tx, t1, $async$temp1;
      var $async$read = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = B.Database_methods;
              $async$goto = 3;
              return A._asyncAwait(A.openDb(), $async$read);
            case 3:
              // returning from await.
              tx = $async$temp1.transaction$2($async$result, "myStore", "readonly");
              t1 = tx.objectStore("myStore");
              t1.toString;
              $async$goto = 4;
              return A._asyncAwait(B.ObjectStore_methods.getObject$1(t1, key), $async$read);
            case 4:
              // returning from await.
              result = $async$result;
              $async$goto = 5;
              return A._asyncAwait(B.Transaction_methods.get$completed(tx), $async$read);
            case 5:
              // returning from await.
              $async$returnValue = result != null ? A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(result), type$.String, type$.dynamic) : null;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$read, $async$completer);
    },
    update(key, data) {
      return A.update$body(key, data);
    },
    update$body(key, data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        tx, t1, $async$temp1;
      var $async$update = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = B.Database_methods;
              $async$goto = 2;
              return A._asyncAwait(A.openDb(), $async$update);
            case 2:
              // returning from await.
              tx = $async$temp1.transaction$2($async$result, "myStore", "readwrite");
              t1 = tx.objectStore("myStore");
              t1.toString;
              $async$goto = 3;
              return A._asyncAwait(B.ObjectStore_methods.put$2(t1, data, key), $async$update);
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(B.Transaction_methods.get$completed(tx), $async$update);
            case 4:
              // returning from await.
              // implicit return
      ...
      return A._asyncStartSync($async$update, $async$completer);
    },
    deleteRecord(key) {
      return A.deleteRecord$body(key);
    },
    deleteRecord$body(key) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        tx, t1, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = B.Database_methods;
              $async$goto = 2;
              return A._asyncAwait(A.openDb(), $async$deleteRecord);
            case 2:
              // returning from await.
              tx = $async$temp1.transaction$2($async$result, "myStore", "readwrite");
              t1 = tx.objectStore("myStore");
              t1.toString;
              $async$goto = 3;
              return A._asyncAwait(B.ObjectStore_methods.delete$1(t1, key), $async$deleteRecord);
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(B.Transaction_methods.get$completed(tx), $async$deleteRecord);
            case 4:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
    ...
    main() {
      var t3, t4, t5, t6, inputKey, inputFoo, inputBar,
        t1 = document,
        t2 = t1.querySelector("#create");
      t2.toString;
      t3 = t1.querySelector("#read");
      t3.toString;
      t4 = t1.querySelector("#update");
      t4.toString;
      t5 = t1.querySelector("#delete");
      t5.toString;
      t6 = type$.InputElement;
      inputKey = t6._as(t1.querySelector("#key"));
      inputFoo = t6._as(t1.querySelector("#foo"));
      inputBar = t6._as(t1.querySelector("#bar"));
      t2 = J.get$onClick$x(t2);
      t1 = t2.$ti;
      A._EventStreamSubscription$(t2._target, t2._eventType, t1._eval$1("~(1)?")._as(new A.main_closure(inputFoo, inputBar, inputKey)), false, t1._precomputed1);
      t3 = J.get$onClick$x(t3);
      t1 = t3.$ti;
      A._EventStreamSubscription$(t3._target, t3._eventType, t1._eval$1("~(1)?")._as(new A.main_closure0(inputKey)), false, t1._precomputed1);
      t4 = J.get$onClick$x(t4);
      t1 = t4.$ti;
      A._EventStreamSubscription$(t4._target, t4._eventType, t1._eval$1("~(1)?")._as(new A.main_closure1(inputKey, inputFoo, inputBar)), false, t1._precomputed1);
      t5 = J.get$onClick$x(t5);
      t1 = t5.$ti;
      A._EventStreamSubscription$(t5._target, t5._eventType, t1._eval$1("~(1)?")._as(new A.main_closure2(inputKey)), false, t1._precomputed1);
    },
    openDb_closure: function openDb_closure() {
    },
  ...
  A.ObjectStore.prototype = {
    ...
    _indexed_db$_add$2(receiver, value, key) {
      var t1 = receiver.add(new A._StructuredCloneDart2Js([], []).walk$1(value));
      t1.toString;
      return t1;
    },
    _indexed_db$_add$1(receiver, value) {
  ...
  A.openDb_closure.prototype = {
    call$1(e) {
      ...
      if (!B.DomStringList_methods.contains$1(db.objectStoreNames, "myStore")) {
        t1 = type$.dynamic;
        options = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
        options.$indexSet(0, "autoIncrement", true);
        B.Database_methods._createObjectStore$2(db, "myStore", options);
      }
    },
    $signature: 29
  };
  A.main_closure.prototype = {
    call$1(_) {
      return this.$call$body$main_closure2(type$.MouseEvent._as(_));
    },
    $call$body$main_closure2(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t2, data, key, t1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.inputFoo.value;
              if (t1 == null)
                t1 = "";
              t2 = $async$self.inputBar.value;
              t2 = A.Primitives_parseInt(t2 == null ? "" : t2, null);
              data = A.LinkedHashMap_LinkedHashMap$_literal(["foo", t1, "bar", t2 == null ? 0 : t2], type$.String, type$.Object);
              $async$goto = 2;
              return A._asyncAwait(A.create(data), $async$call$1);
            case 2:
              // returning from await.
              key = $async$result;
              B.InputElement_methods.set$value($async$self.inputKey, B.JSInt_methods.toString$0(key));
              t1 = data.toString$0(0);
              t2 = document.querySelector("#output");
              t2.toString;
              J.appendHtml$1$x(t2, "<p>" + ("Created with key " + A.S(key) + ": " + t1) + "</p>");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.main_closure0.prototype = {
    call$1(_) {
      return this.$call$body$main_closure1(type$.MouseEvent._as(_));
    },
    $call$body$main_closure1(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, t2, t1, key, $async$temp1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.inputKey.value;
              key = A.Primitives_parseInt(t1 == null ? "" : t1, null);
              if (key == null) {
                t1 = document.querySelector("#output");
                t1.toString;
                J.appendHtml$1$x(t1, "<p>Invalid key</p>");
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.read(key), $async$call$1);
            case 3:
              // returning from await.
              t1 = $async$temp1.S($async$result);
              t2 = document.querySelector("#output");
              t2.toString;
              J.appendHtml$1$x(t2, "<p>" + ("Read from key " + A.S(key) + ": " + t1) + "</p>");
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A.main_closure1.prototype = {
    call$1(_) {
      return this.$call$body$main_closure0(type$.MouseEvent._as(_));
    },
    $call$body$main_closure0(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, t2, data, t1, key;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              data = A.LinkedHashMap_LinkedHashMap$_literal(["foo", t1, "bar", t2 == null ? 0 : t2], type$.String, type$.Object);
              $async$goto = 3;
              return A._asyncAwait(A.update(key, data), $async$call$1);
            case 3:
              // returning from await.
              t1 = data.toString$0(0);
              t2 = document.querySelector("#output");
              t2.toString;
              J.appendHtml$1$x(t2, "<p>" + ("Updated key " + A.S(key) + " with " + t1) + "</p>");
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A.main_closure2.prototype = {
    ...
    $call$body$main_closure(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, t1, key;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.deleteRecord(key), $async$call$1);
            case 3:
              // returning from await.
              t1 = document.querySelector("#output");
              t1.toString;
              J.appendHtml$1$x(t1, "<p>" + ("Deleted key " + A.S(key)) + "</p>");
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A.Stream_first_closure0, A._RootZone_bindUnaryCallbackGuarded_closure, A.Element_Element$html_closure, A._EventStreamSubscription_closure, A._EventStreamSubscription_onData_closure, A.NodeValidatorBuilder_allowsElement_closure, A.NodeValidatorBuilder_allowsAttribute_closure, A._SimpleNodeValidator_closure, A._SimpleNodeValidator_closure0, A._TemplatingNodeValidator_closure, A._convertDartToNative_Value_closure, A._completeRequest_closure, A.Transaction_completed_closure, A.Transaction_completed_closure0, A.Transaction_completed_closure1, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.openDb_closure, A.main_closure, A.main_closure0, A.main_closure1, A.main_closure2]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainCoreFuture_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteErrorObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A.Stream_first_closure, A._cancelAndValue_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure]);
    ...
    _inheritMany(A.Event, [A.UIEvent, A.VersionChangeEvent]);
