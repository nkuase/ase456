...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ObjectStoreNative_add_closure: function ObjectStoreNative_add_closure(t0, t1, t2) {
      this.$this = t0;
      this.key = t1;
      this.value = t2;
    },
    ObjectStoreNative_add__closure: function ObjectStoreNative_add__closure() {
    },
    ...
    ObjectStoreSembast_add_closure: function ObjectStoreSembast_add_closure(t0, t1, t2) {
      this._box_0 = t0;
      this.$this = t1;
      this.key = t2;
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.idbFactoryBrowser().open$3$onUpgradeNeeded$version("myDB", new A.openDb_closure(), 1), $async$openDb);
            case 3:
              // returning from await.
              $async$returnValue = $async$result;
              // goto return
      ...
      var $async$create = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              // returning from await.
              txn = $async$result.transaction$2("myStore", "readwrite");
              $async$goto = 4;
              return A._asyncAwait(txn.objectStore$1("myStore").add$1(0, data), $async$create);
            case 4:
              // returning from await.
              key = $async$result;
              $async$goto = 5;
              return A._asyncAwait(txn.get$completed(), $async$create);
            case 5:
              // returning from await.
      ...
      var $async$read = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              // returning from await.
              txn = $async$result.transaction$2("myStore", "readonly");
              $async$goto = 4;
              return A._asyncAwait(txn.objectStore$1("myStore").getObject$1(key), $async$read);
            case 4:
              // returning from await.
              result = $async$result;
              $async$goto = 5;
              return A._asyncAwait(txn.get$completed(), $async$read);
            case 5:
              // returning from await.
              if (result != null && type$.Map_dynamic_dynamic._is(result)) {
                $async$returnValue = A.LinkedHashMap_LinkedHashMap$from(result, type$.String, type$.dynamic);
                // goto return
                $async$goto = 1;
                break;
              }
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              txn = $async$result.transaction$2("myStore", "readwrite");
              $async$goto = 3;
              return A._asyncAwait(txn.objectStore$1("myStore").put$2(data, key), $async$update);
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(txn.get$completed(), $async$update);
            case 4:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              txn = $async$result.transaction$2("myStore", "readwrite");
              $async$goto = 3;
              return A._asyncAwait(txn.objectStore$1("myStore").delete$1(key), $async$deleteRecord);
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(txn.get$completed(), $async$deleteRecord);
            case 4:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
    ...
    showOutput(msg) {
      var _this,
        t1 = init.G,
        t2 = type$.JSObject,
        outputDiv = type$.nullable_JSObject._as(t2._as(t1.document).querySelector("#output"));
      if (outputDiv != null) {
        _this = t2._as(t2._as(t1.document).createElement("p"));
        _this.textContent = msg;
        t2._as(outputDiv.appendChild(_this));
      }
    },
    main() {
      var t1 = init.G,
        ...
        createBtn = t3._as(t2._as(t1.document).querySelector("#create")),
        readBtn = t3._as(t2._as(t1.document).querySelector("#read")),
        updateBtn = t3._as(t2._as(t1.document).querySelector("#update")),
        deleteBtn = t3._as(t2._as(t1.document).querySelector("#delete")),
        inputKey = t3._as(t2._as(t1.document).querySelector("#key")),
        inputFoo = t3._as(t2._as(t1.document).querySelector("#foo")),
        inputBar = t3._as(t2._as(t1.document).querySelector("#bar"));
      t1 = new A.main_parseKey();
      if (createBtn != null)
        createBtn.onclick = A._functionToJS0(new A.main_handleCreate(inputFoo, inputBar, inputKey));
      if (readBtn != null)
        readBtn.onclick = A._functionToJS0(new A.main_handleRead(inputKey, t1));
      if (updateBtn != null)
        updateBtn.onclick = A._functionToJS0(new A.main_handleUpdate(inputKey, inputFoo, inputBar, t1));
      if (deleteBtn != null)
        deleteBtn.onclick = A._functionToJS0(new A.main_handleDelete(inputKey, t1));
    },
    openDb_closure: function openDb_closure() {
    },
    main_parseKey: function main_parseKey() {
    },
    main_handleCreate: function main_handleCreate(t0, t1, t2) {
      this.inputFoo = t0;
      this.inputBar = t1;
      this.inputKey = t2;
    },
    main_handleRead: function main_handleRead(t0, t1) {
      this.inputKey = t0;
      this.parseKey = t1;
    },
    main_handleUpdate: function main_handleUpdate(t0, t1, t2, t3) {
      var _ = this;
      _.inputKey = t0;
      _.inputFoo = t1;
      _.inputBar = t2;
    ...
    main_handleDelete: function main_handleDelete(t0, t1) {
      this.inputKey = t0;
      this.parseKey = t1;
    },
    Finder_Finder(filter, limit) {
      var _null = null;
      return new A.SembastFinder(filter, _null, limit, _null, _null, _null);
    },
    printString(string) {
  ...
  A.DatabaseNative.prototype = {
    createObjectStore$2$autoIncrement($name, autoIncrement) {
      var t1 = A.catchNativeError(new A.DatabaseNative_createObjectStore_closure(this, $name, null, true), type$.nullable_ObjectStore);
      t1.toString;
      return t1;
    },
    transaction$2(storeNameOrStoreNames, mode) {
  ...
  A.DatabaseNative_createObjectStore_closure.prototype = {
    call$0() {
      return new A.ObjectStoreNative(type$.JSObject._as(this.$this.idbDatabase.createObjectStore(this.name, {keyPath: null, autoIncrement: this.autoIncrement})));
    },
    $signature: 20
  };
  ...
  A.ObjectStoreNative.prototype = {
    add$1(_, value) {
      return A.catchAsyncNativeError(new A.ObjectStoreNative_add_closure(this, null, value), type$.Object);
    },
    getObject$1(key) {
  ...
  A.ObjectStoreNative_add_closure.prototype = {
    call$0() {
      return A.IDBRequestExt_get_future(type$.JSObject._as(this.$this.idbObjectStore.add(A.IDBJsifyExtension_jsifyValueStrict(this.value)))).then$1$1(new A.ObjectStoreNative_add__closure(), type$.Object);
    },
    $signature: 8
  };
  A.ObjectStoreNative_add__closure.prototype = {
    call$1(value) {
      value.toString;
      return A.IDBDartifyExtension_dartifyValueStrict(value);
    },
    $signature: 15
  };
  ...
  A.DatabaseSembast.prototype = {
    ...
    createObjectStore$2$autoIncrement($name, autoIncrement) {
      var storeMeta = A.IdbObjectStoreMeta$($name, null, true, null),
        t1 = this.meta,
  ...
  A.ObjectStoreSembast.prototype = {
    ...
    getKeyImpl$2(value, key) {
      ...
      if (t2 != null) {
        if (key != null)
          throw A.wrapException(A.ArgumentError$("The object store uses in-line keys and the key parameter '" + A.S(key) + "' was provided", null));
        if (type$.Map_dynamic_dynamic._is(value))
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.Object;
              $async$goto = 3;
              return A._asyncAwait(A.SembastStoreRefExtension_findKey($async$self.get$sembastStore(), $async$self.get$sembastClient(), A.Finder_Finder(A.keyFilter($async$self.meta.keyPath, key, false), null), t1, t1), $async$txnCompositeFindIdByKey$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$result;
              // goto return
    ...
    add$1(_, value) {
      var t1 = {};
      t1.value = value;
      t1.value = A.toSembastValue(value);
      return this._inWritableTransaction$1$1(new A.ObjectStoreSembast_add_closure(t1, this, null), type$.Object);
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.Object;
              $async$goto = 3;
              return A._asyncAwait(A.SembastStoreRefExtension_findFirst($async$self.get$sembastStore(), $async$self.get$sembastClient(), A.Finder_Finder(A.keyFilter($async$self.meta.keyPath, key, false), null), t1, t1), $async$txnCompositeGetSnapshot$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$result;
              // goto return
    ...
    txnDelete$1(keyOrRange) {
      var t3, t4, _this = this,
        ...
        t2 = type$.Object;
      if (type$.Iterable_dynamic._is(t1))
        return A.SembastStoreRefExtension_delete(_this.get$sembastStore(), _this.get$sembastClient(), A.Finder_Finder(A.keyFilter(t1, keyOrRange, false), null), t2, t2);
      else {
  ...
  A.ObjectStoreSembast_add_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Object),
        $async$returnValue, $async$self = this, t1, t2, t3, fixedKey;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t3 = $async$self.key;
              fixedKey = t1.getKeyImpl$2(t2.value, t3);
              $async$goto = fixedKey != null ? 3 : 5;
              break;
            case 3:
              // then
              $async$goto = 6;
              return A._asyncAwait(t1.txnGetSnapshot$1(fixedKey), $async$call$0);
            case 6:
              // returning from await.
              if ($async$result != null)
                throw A.wrapException(A.DatabaseError$("Key " + A.S(t3) + " already exists in the object store"));
              $async$returnValue = t1.putImpl$2(t2.value, fixedKey);
              // goto return
              $async$goto = 1;
              break;
              // goto join
            ...
            case 5:
              // else
              $async$returnValue = t1.putImpl$2(t2.value, null);
              // goto return
              $async$goto = 1;
              break;
            case 4:
  ...
  A.Cooperator.prototype = {
    ...
    cooperate$0() {
      ...
      if (_this.get$needCooperate()) {
        ...
        if (!_this._paused) {
          _this._paused = true;
          return A.Future_Future$delayed(A.Duration$(1), null, t1).then$1$1(new A.Cooperator_cooperate_closure(_this), t1);
        } else
          return A.Future_Future$delayed(A.Duration$(1), null, t1);
      } else
        return null;
    }
  };
  ...
  A.SembastFinder.prototype = {
    compare$2(record1, record2) {
      ...
      if (t1 != null)
        for (; 0 < t1.length;) {
          result0 = t1[0].compare$2(record1, record2);
          result = result0;
          break;
        }
      return result;
  ...
  A.openDb_closure.prototype = {
    call$1(e) {
      var db = e.get$target().result;
      if (!J.contains$1$asx(db.get$objectStoreNames(), "myStore"))
        db.createObjectStore$2$autoIncrement("myStore", true);
    },
    $signature: 75
  };
  A.main_parseKey.prototype = {
    call$1(value) {
      return A.Primitives_parseInt(value, null);
    },
    $signature: 76
  };
  A.main_handleCreate.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, t2, data, key, t1;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.inputFoo;
              if (t1 == null || $async$self.inputBar == null || $async$self.inputKey == null) {
                // goto return
                $async$goto = 1;
                break;
              }
              t1 = A._asString(t1.value);
              t2 = A._asString($async$self.inputBar.value);
              t2 = A.Primitives_parseInt(t2, null);
              data = A.LinkedHashMap_LinkedHashMap$_literal(["foo", t1, "bar", t2 == null ? 0 : t2], type$.String, type$.Object);
              $async$goto = 3;
              return A._asyncAwait(A.create(data), $async$call$0);
            case 3:
              // returning from await.
              key = $async$result;
              $async$self.inputKey.value = B.JSInt_methods.toString$0(key);
              A.showOutput("Created with key " + A.S(key) + ": " + data.toString$0(0));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A.main_handleRead.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, key, t1, $async$temp1, $async$temp2, $async$temp3;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.inputKey;
              if (t1 == null) {
                // goto return
                $async$goto = 1;
                break;
              }
              key = $async$self.parseKey.call$1(A._asString(t1.value));
              if (key == null) {
                A.showOutput("Invalid key");
                // goto return
                $async$goto = 1;
                break;
              }
              $async$temp1 = A;
              $async$temp2 = "Read from key " + A.S(key) + ": ";
              $async$temp3 = A;
              $async$goto = 3;
              return A._asyncAwait(A.read(key), $async$call$0);
            case 3:
              // returning from await.
              $async$temp1.showOutput($async$temp2 + $async$temp3.S($async$result));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A.main_handleUpdate.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, key, t2, data, t1;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.inputKey;
              if (t1 == null || $async$self.inputFoo == null || $async$self.inputBar == null) {
                // goto return
                $async$goto = 1;
                break;
              }
              ...
              t1 = A._asString($async$self.inputFoo.value);
              t2 = A._asString($async$self.inputBar.value);
              t2 = A.Primitives_parseInt(t2, null);
              data = A.LinkedHashMap_LinkedHashMap$_literal(["foo", t1, "bar", t2 == null ? 0 : t2], type$.String, type$.Object);
              $async$goto = 3;
              return A._asyncAwait(A.update(key, data), $async$call$0);
            case 3:
              // returning from await.
              A.showOutput("Updated key " + A.S(key) + " with " + data.toString$0(0));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A.main_handleDelete.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, key, t1;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.deleteRecord(key), $async$call$0);
            case 3:
              // returning from await.
              A.showOutput("Deleted key " + A.S(key));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_1_u(_ = A._StreamIterator.prototype, "get$_async$_onData", "_async$_onData$1", 50);
    ...
    _instance(A._LinkedHashSet.prototype, "get$_newSimilarSet", 0, 0, null, ["call$1$0", "call$0"], ["_newSimilarSet$1$0", "_newSimilarSet$0"], 36, 0, 0);
    ...
    _instance_1_u(_, "get$isValidKey", "isValidKey$1", 1);
    _instance_1_u(A._FinderData.prototype, "get$addRecord", "addRecord$1", 67);
    _static_2(A, "utils__compareKey$closure", "compareKey", 24);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(Object?)", "~(@,@)", "Future<@>()", "Null(JSObject)", "@(@)", "Null(@)", "Null()", "Future<Object>()", "Future<Object?>()", "Future<Null>()", "~(~())", "bool(Object?,Object?)", "int(Object?)", "Future<~>()", "Object(Object?)", "MapEntry<String,Object?>(@,@)", "~(Object?,Object?)", "int(String?)", "ImmutableSembastRecord(TxnRecord)", "ObjectStoreNative()", "~(JSObject)", "Null(Object,StackTrace)", "int()", "int(@,@)", "bool(Finder?,ImmutableSembastRecord)", "Future<int>(SembastTransaction)", "~(String)", "TransactionNative()", "Iterable<String>()", "String()", "@(@,String)", "~(int,@)", "~(Object,StackTrace)", "Completer<Object?>()", "Database(@)", "Set<0^>()<Object?>", "List<IdbObjectStoreMeta>(List<RecordSnapshot<String,Object>?>)", "~(RecordSnapshot<String,Object>?)", "Future<int>(Transaction)", "Null(List<IdbObjectStoreMeta>)", "~(IdbObjectStoreMeta)", "Null(Database0,int,int)", "@(String)", "Future<Null>(Transaction)", "bool(RecordSnapshot<Object?,Object?>)", "Null(RecordSnapshot<Object,Object>?)", "Future<Object>(List<@>)", "Object(Object)", "Future<@>(@)", "~(Object?)", "Future<@>(Transaction)", "int(IdbIndexMeta,IdbIndexMeta)", "Future<Null>(~)", "Future<Null>(@)", "bool()", "String(int)", "Future<@>(String)", "Future<@>(Map<@,@>)", "Future<@>(int?,int?)", "Future<Object?>(Transaction)", "Future<SembastDatabase>()", "Future<Object?>(SembastTransaction)", "~(@)", "int(SembastRecord,SembastRecord)", "int(ImmutableSembastRecord,ImmutableSembastRecord)", "Object?(SembastRecord)", "bool(ImmutableSembastRecord)", "Future<~>(SembastTransaction)", "Null(~())", "String(Timestamp)", "Timestamp(String)", "String(Blob)", "Blob(String)", "Object?(Object?)", "Null(VersionChangeEvent)", "int?(String?)", "Null(@,StackTrace)", "Null(Object)"],
