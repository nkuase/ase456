...
class DatabaseAbstractionDemo {
  ...
  static Future<void> switchingDatabases() async {
    ...
    // Example 2: Using Firebase (would need to import the adapter)
    print('\n📊 Testing with Firebase would work the same way...');
    print('DatabaseService firebaseDb = FirebaseDatabaseAdapter();');
    print('await runDatabaseDemo(firebaseDb, "Firebase");');
    
    // Example 3: Using Mock database for testing
    print('\n🧪 Testing with Mock database...');
    DatabaseService mockDb = MockDatabaseService();
