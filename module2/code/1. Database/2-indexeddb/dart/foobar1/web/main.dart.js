...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      t3._as(t2._as(t1.document).querySelector("#create"));
      t3._as(t2._as(t1.document).querySelector("#read"));
      t3._as(t2._as(t1.document).querySelector("#update"));
      t3._as(t2._as(t1.document).querySelector("#delete"));
      t3._as(t2._as(t1.document).querySelector("#key"));
      t3._as(t2._as(t1.document).querySelector("#foo"));
      t3._as(t2._as(t1.document).querySelector("#bar"));
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.FixedLengthListMixin, A.Closure, A._Record, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A.Null, A.StringBuffer]);
